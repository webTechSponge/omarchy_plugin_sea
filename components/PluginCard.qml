...
Ui.BorderSurface {
    ...
    Column {
        ...
        Text { width: parent.width; text: card.plugin.name || card.plugin.id; textFormat: Text.PlainText; color: Color.foreground; font.family: Style.font.family; font.pixelSize: Style.font.heading; font.bold: true; elide: Text.ElideRight }
