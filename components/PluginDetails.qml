...
ColumnLayout {
    ...
    Controls.ScrollView {
        ...
        Column {
            ...
            Text {
                width: parent.width
                text: !detail.installedSourceLink ? "AI review unavailable: no supported GitHub source is known for this plugin." : detail.reviewMessage || "Review with AI opens an advisory Codex session for the public repository, not the installed revision. No tests, installation or plugin execution are requested; it does not verify safety."
    ...
    Flow {
        ...
        Ui.Button { text: "Review with AI"; bordered: true; focusable: true; enabled: !detail.busy && detail.reviewAvailable && !!detail.installedSourceLink; onClicked: detail.actionRequested("review") }
        ...
        Ui.Button { visible: !detail.plugin.localOnly; text: detail.hearted ? "❤️ Hearted" : "❤️ Send a heart"; bordered: true; focusable: true; enabled: !detail.busy && !detail.hearted; onClicked: detail.actionRequested("heart") }
    }
}
