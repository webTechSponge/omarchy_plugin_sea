...
ColumnLayout {
    ...
    Flow {
        ...
        Ui.Button { visible: !detail.plugin.localOnly; text: detail.hearted ? "♥ Hearted" : "♥ Send a heart"; bordered: true; focusable: true; enabled: !detail.busy && !detail.hearted; onClicked: detail.actionRequested("heart") }
    }
}
