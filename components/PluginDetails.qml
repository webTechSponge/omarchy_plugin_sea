...
ColumnLayout {
    ...
    Flow {
        ...
        Ui.Button { text: "View source ↗"; bordered: true; focusable: true; enabled: Catalog.safeLink(detail.plugin.repo); opacity: enabled ? 1 : 0.4; onClicked: Qt.openUrlExternally(detail.plugin.repo) }
